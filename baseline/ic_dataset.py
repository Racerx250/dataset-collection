...
def get_icdataset_train_test(database_dir_path:str, db_name:str = '', train_perc:float = 1) -> ICDataset:
    ...
    return ICDataset(train_db, database_dir_path=database_dir_path, db_name=db_name), ICDataset(test_db, database_dir_path=database_dir_path, db_name=db_name)

if __name__ == '__main__':
    # NEED TO MOVE BELOW TO TESTS
    pass

    # temp = get_icdataset('dataset_dogs_small_dirty', use_int_labels=True)
    # print(temp[0])
